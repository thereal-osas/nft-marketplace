...
function Toast(val,time,flag) {
    ...
    if(flag==1){
        noti_html.className = "notification alert alert-success";
    }else if(flag==0 || flag==2){
        noti_html.className = "notification alert alert-danger";
    }else {
        noti_html.className = "notification alert alert-warning";
    }
